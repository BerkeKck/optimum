class Photos {
  static const String _assetPath = 'assets/photos/';
  ...
  static List<String> tshirtPhotos = [
  ...
  static List<String> pantsPhotos = [
  ...
  static List<String> shoesPhotos = [
  ...
  static List<String> dressPhotos = [
  ...
  static List<String> skirtsPhotos = [
    'assets/photos/Skirts-1.jpg',
    'assets/photos/Skirts-2.jpg',
  ];

  static List<String> handbagPhotos = [
